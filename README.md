...
| -------------- | ---------- | -------- | ----------- |
| `layout_dir`   | `string`   | no       | The layout directory, relative to your `%twig.default_path%`. Can be a legacy path `@Layout/test` and will be parsed as a symfony-namespaced twig path. |
