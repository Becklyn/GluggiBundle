...
let router = new _gluggi_GluggiRouter__WEBPACK_IMPORTED_MODULE_4__["GluggiRouter"](data.url);
...
class GluggiRouter {
  ...
  component(type, key) {
    return "".concat(this.prefix).concat(type, "/").concat(key);
  }
